...
class Num_value:
    ...
    def __mul__(self, other):
        ...
        return Num_value(res_value, res_value * rel_dispersion)
...
def get_value(obj: Union[Num_value, float, int]):
...
def get_dispersion(obj : Union[Num_value, float, int]):
    if type(obj) == Num_value:
...
def get_relative_dispersion(obj : Union[Num_value, float, int]):
    if type(obj) == Num_value:
